...
public abstract class SymbolPropertiesOld extends StructObject {
	static {
		BridJ.register();
	}
	/**
	...
	/** symbol spread */
	@Field(2) 
	public SymbolPropertiesOld spread(int spread) {
	...
	/** spread balance */
	@Field(3) 
	public SymbolPropertiesOld spread_balance(int spread_balance) {
	...
	/** stops level */
	@Field(4) 
	public SymbolPropertiesOld stops_level(int stops_level) {
	...
	/** execution mode */
	@Field(5) 
	public SymbolPropertiesOld exemode(int exemode) {
		this.io.setIntField(this, 5, exemode);
		return this;
	}
}
